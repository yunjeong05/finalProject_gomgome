...
@Entity
@Table(name="t_gomg_post_image")
@Data
@SequenceGenerator(
		name="PostImageSequenceGenerator",
...
public class PostImage {
	...
	@GeneratedValue(
			...
			generator="PostImageSequenceGenerator"
	)
	...
	private LocalDateTime postImageRegdate = LocalDateTime.now();
